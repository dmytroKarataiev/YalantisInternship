    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                Log.d(TAG, "MotionEvent.ACTION_DOWN:" + MotionEvent.ACTION_DOWN);
            ...
            case MotionEvent.ACTION_MOVE:
                Log.d(TAG, "MotionEvent.ACTION_MOVE:" + MotionEvent.ACTION_MOVE);
            ...
            case MotionEvent.ACTION_CANCEL:
                Log.d(TAG, "MotionEvent.ACTION_UP:" + MotionEvent.ACTION_UP);
                mIsBeingDragged = false;
